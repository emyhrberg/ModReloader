...
namespace ModHelper.UI.Elements.SpawnerElements
{
    /// <summary>
    ...
    public abstract class SpawnerPanel : DraggablePanel
    {
        ...
        public TextBox GetCustomTextBox() => SearchTextBox;
        private float padding = 12f; // padding between elements

        // Resize button
        private ResizeIcon spawnerResizeButton;
        ...
        public SpawnerPanel(string header) : base(header)
        {
            ...
            ItemsGrid = new Grid
            {
                ...
                ManualSortMethod = (listUIElement) => { }
            };
            ItemsGrid.SetScrollbar(Scrollbar);

            // Resize
            spawnerResizeButton = new(Ass.Resize);
            spawnerResizeButton.OnDragY += offsetY =>
            {
                ...
                // Clamp max height
                if (newHeight > Height.Pixels + 60f || newHeight < maxHeight)
                {
                    return;
                }
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (spawnerResizeButton != null && spawnerResizeButton.draggingResize)
            {
