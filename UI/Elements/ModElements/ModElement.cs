...
namespace ModHelper.UI.Elements.ModElements
{
    ...
    public class ModElement : UIPanel
    {
        ...
        private ModState state = ModState.Enabled; // enabled by default
        ...
        // State
        public ModState GetState() => state;
        ...
        public override void LeftClick(UIMouseEvent evt)
        {
            ...
            SetState(state == ModState.Enabled ? ModState.Disabled : ModState.Enabled);
            enabledText.SetTextState(state);

            // Use reflection to call SetModEnabled on internalModName
            bool enabled = state == ModState.Enabled;
