...
namespace ModReloader.Common.Integrations.HEROsMod
{
    ...
    public sealed class HerosModIntegration : ModSystem
    {
        ...
        private static void RegisterModsButton(Mod herosMod)
        {
            ...
            () => GetTooltip(ModContent.GetInstance<MainSystem>().mainState.modsPanel, "ModsButton")
            );
        }
        ...
        private static void RegisterUIButton(Mod herosMod)
        {
            ...
            () => GetTooltip(ModContent.GetInstance<MainSystem>().mainState.uiElementPanel, "UIElementButton")
            );
        }
        ...
        private static void RegisterLogButton(Mod herosMod)
        {
            ...
            () => GetTooltip(ModContent.GetInstance<MainSystem>().mainState.logPanel, "LogButton")
            );
        }
