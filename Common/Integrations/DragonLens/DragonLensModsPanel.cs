...
namespace ModReloader.Common.Integrations.DragonLens
{
    ...
    {
        public override string IconKey => Loc.Get("ModsButton.Text");

        public override string DisplayName => Loc.Get("ModsButton.HoverText");

        public override string Description => Loc.Get("ModsButton.HoverDesc");
