...
{
    /// Updates the game to keep running even when the window is not focused.
    /// Used in World Panel.
    /// TODO:
    /// - Fix rain
    /// - Fix logging not working when the game is not focused
    /// - Probably more stuff
    public class KeepGameRunningSystem : ModSystem
    {
