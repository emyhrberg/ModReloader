...
using ModReloader.Core.Features.ModToggler.UI.Filters;
...
namespace ModReloader.Core.Features.ModToggler.UI
{
    ...
    public class ModsPanel : BasePanel
    {
        ...
        // filters
        public readonly ModViewFilterImage modChangeView; // filter mods view image button
        public readonly ModToggleFilterImage modFilterEnabled; // filter enabled mods button
        ...
        public ModsPanel() : base(header: "Manage Mods", scrollbarEnabled: true)
        {
            ...
            ToggleAllPanel enableAllPanel = new(
                color: Color.Green,
                text: "Enable All",
            ...
            ToggleAllPanel disableAllPanel = new(
        ...
        public void FilterMods()
        {
            ...
            foreach (ModElement modElement in allModsCombined)
            {
                ...
                if (modFilterEnabled.currentEnabledDisabledView == ModToggleFilterImage.ModFilterEnabledDisabled.Enabled)
                {
                    matchEnabledDisabled = modElement.GetState() == EnabledState.Enabled;
                }
                else if (modFilterEnabled.currentEnabledDisabledView == ModToggleFilterImage.ModFilterEnabledDisabled.Disabled)
                {
