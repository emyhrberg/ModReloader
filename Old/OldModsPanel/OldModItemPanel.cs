...
//             // --- Mod Icon ---
//             Asset<Texture2D> def = Main.Assets.Request<Texture2D>("Images/UI/DefaultResourcePackIcon", AssetRequestMode.ImmediateLoad);
//             Asset<Texture2D> empty = TextureAssets.MagicPixel;

//             if (modPath != null)
//             {
//                 float size = 20f;
//                 ModImage modImage = new(def.Value, modPath)
//                 {
//                     Left = { Pixels = 0 },
//                     Top = { Pixels = 0 },
//                     Width = { Pixels = 0 },
